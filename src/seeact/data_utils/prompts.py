...
Important: Always output a valid action from the allowed set and select an element (or the final "None of the other options" choice) based on the provided multi-choice list. Do not refuse to answer. If uncertain, choose the most reasonable option using the screenshot and the DOM details.'''
